# Django settings for selfevaluation project.

# --------------------------------------------------------------
# Parameters to make this django project works in all computers.
...
ROOT_PATH = "/".join(CURRENT_PATH.split("/")[0:-1])    # Root path selfevaluatio

DATABASE_PATH = ROOT_PATH + '/db.dummy'
...
SECRET_KEY = 'j6tsk3&amp;y2&amp;_xcte=_gw6(7(yvb(^fuxf7h7f_+2&amp;uvt9$3ee^^'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(ROOT_PATH, templates_dir)
)
